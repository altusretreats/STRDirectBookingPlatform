...
- Food discovery and host picks were deployed 2026-08-13 across the admin, Guidebook, and property site. Restaurant place items now receive their own Food journey and **Eat nearby** property-page group, non-restaurant places remain under Explore / **Things to do nearby**, and `item.featured` powers the admin **Our Pick** toggle, featured-first sorting, and restrained Canyon badges on both guest surfaces.
